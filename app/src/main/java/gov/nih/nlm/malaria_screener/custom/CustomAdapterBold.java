...
/**
 * Created by yuh5 on 5/10/2016.
 */
public class CustomAdapterBold extends BaseAdapter {

    Context context;
    List<RowItem> rowItems;

    public CustomAdapterBold(Context context, List<RowItem> rowItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(gov.nih.nlm.malaria_screener.R.layout.list_item_bold, null);
