...
//                Core.compare(watershed_result, newOnes, watershed_result, Core.CMP_GT);
    ...
    private Mat calculate_loG(Mat im, int sigma) {
        ...
        //Log.i(TAG, "GaussX: " + GaussX);
        //Log.i(TAG, "GaussX: " + GaussX.get(0,0)[0] + " " + GaussX.get(0,1)[0] + " " + GaussX.get(0,2)[0] + " " + GaussX.get(0,3)[0]);
        ...
        //Log.i(TAG, "dGxx: " + dGxx);
        //.i(TAG, "dGxx: " + dGxx.get(0, 0)[0] + " " + dGxx.get(0, 1)[0] + " " + dGxx.get(0, 2)[0] + " " + dGxx.get(0, 3)[0]);
        //Log.i(TAG, "markers: " + markers.get(i, j)[0]);
