...
public class SeekBarPreference_WBCNeeded extends Preference implements OnSeekBarChangeListener
{
	private static final String ANDROIDNS = "http://schemas.android.com/apk/res/android";
	private static final String ROBOBUNNYNS = "http://robobunny.com";
	private int DEFAULT_VALUE = 200;
	...
	public SeekBarPreference_WBCNeeded(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		setValuesFromXml(attrs);
	}

	public SeekBarPreference_WBCNeeded(Context context, AttributeSet attrs, int defStyle)
	{
	...
	{
		maxValue = attrs.getAttributeIntValue(ANDROIDNS, "max", 300);
		minValue = attrs.getAttributeIntValue(ROBOBUNNYNS, "min", 1);
		DEFAULT_VALUE = attrs.getAttributeIntValue(ROBOBUNNYNS, "defaultValue", 200);
