...
public class SeekBarPreference_4CellNeeded extends Preference implements OnSeekBarChangeListener
{
	...
	public SeekBarPreference_4CellNeeded(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		setValuesFromXml(attrs);
	}

	public SeekBarPreference_4CellNeeded(Context context, AttributeSet attrs, int defStyle)
	{
	...
	{
		maxValue = attrs.getAttributeIntValue(ANDROIDNS, "max", 3000);
		minValue = attrs.getAttributeIntValue(ROBOBUNNYNS, "min", 1);
		DEFAULT_VALUE = attrs.getAttributeIntValue(ROBOBUNNYNS, "defaultValue", 1000);
